...
#Bond axially coordinated residues to preceding and proceeding residues
 ...
 bond  oo.{Ligd}.C   oo.{Ligd+1}.N

 bond  or.{Ligp-1}.C   or.{Ligp}.N
 bond  or.{Ligp}.C   or.{Ligp+1}.N
 bond  or.{Ligd-1}.C   or.{Ligd}.N
 bond  or.{Ligd}.C   or.{Ligd+1}.N

 bond  ro.{Ligp-1}.C   ro.{Ligp}.N
 bond  ro.{Ligp}.C   ro.{Ligp+1}.N
 bond  ro.{Ligd-1}.C   ro.{Ligd}.N
 bond  ro.{Ligd}.C   ro.{Ligd+1}.N

 bond  rr.{Ligp-1}.C   rr.{Ligp}.N
 bond  rr.{Ligp}.C   rr.{Ligp+1}.N
 bond  rr.{Ligd-1}.C   rr.{Ligd}.N
 bond  rr.{Ligd}.C   rr.{Ligd+1}.N
 """, file=open(TLEaPinput, 'a'))

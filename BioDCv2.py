 ...
 ===================================================================\n""")
   ...
   delete it and start over? """)
    ...
    if (DivSel == 0):
        ...
        PolySel, OutPrefix = A2EE.ReorderResByChain(StrucDir, OutPrefix, InputDict)
        A2EE.LinearizeHemeSequence(LaunchDir, InputDict)
        print("""
 ===================================================================  
 Second: Energetic Evalulation
 ===================================================================\n""", end=" ")
        EE.EnergeticEvalulation(LaunchDir, ForceFieldDir, OutPrefix, SolvEnv, PolySel, InputDict)
